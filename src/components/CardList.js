...
const CardList = (props) => {
    ...
    const onClickIconBack = () => props.onClickBack();
    const onClickIconForward = () => props.onClickForward();
    const onClickCard = (value) => props.onClickCard(value);
    ...
    return (
        <div className="card-list-container">
            <div className="card-list-button-arrow" onClick={onClickIconBack}>
                {!props.isFirst && <IoChevronBackOutline />}
            </div>
                    ...
                    return (
                        <div key={`card-list-row-${index}`} className="card-list-box-row">
                            {value.length > 0 && value.map((value1, index1) => {
                                ...
                                return (
                                    <div key={`card-list-col-${index1}`} className="card-list-box-column" onClick={() => onClickCard(value1)}>
                                        <div className="card-list-box-image"></div>
